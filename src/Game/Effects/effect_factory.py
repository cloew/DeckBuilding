...
EffectFactory.addFactory("PER_MATCH", Factory(PerMatch, [PrimitiveParameter("source", optional=True), ComplexParameter("effects", EffectFactory.loadAll), FilterParameter(optional=True)]))
